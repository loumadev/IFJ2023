...
enum ResultType {
	...
	RESULT_ASSERTION = -1,
	RESULT_SUCCESS = 0,
	RESULT_ERROR_LEXICAL_ANALYSIS = 1,
	RESULT_ERROR_SYNTACTIC_ANALYSIS = 2,
	RESULT_ERROR_SEMANTIC_FUNCTION_DEFINITION = 3,
	RESULT_ERROR_SEMANTIC_INVALID_FUNCTION_CALL = 4,
	RESULT_ERROR_SEMANTIC_UNDEFINED_VARIABLE = 5,
	RESULT_ERROR_SEMANTIC_INVALID_RETURN = 6,
	RESULT_ERROR_SEMANTIC_INVALID_TYPE = 7,
