...
// Private
void* Allocator_memoryAction(void *ptr, size_t nitems, size_t size, enum AllocatorAction action) {
...
void Allocator_cleanup() {
	Allocator_memoryAction(NULL, 0, 0, MEMORY_CLEANUP);
}

void* mem_alloc(size_t size) {
	return Allocator_memoryAction(NULL, 0, size, MEMORY_ALLOC);
}

void* mem_calloc(size_t nitems, size_t size) {
	return Allocator_memoryAction(NULL, nitems, size, MEMORY_CALLOC);
}

void* mem_realloc(void *ptr, size_t size) {
	return Allocator_memoryAction(ptr, 0, size, MEMORY_REALLOC);
}

void mem_free(void *ptr) {
	Allocator_memoryAction(ptr, 0, 0, MEMORY_FREE);
}
