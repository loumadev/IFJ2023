...
void __Codegen_resolveGeneratedType(enum BuiltInFunction functionType);
 ...
 *
 * This function generates the code for the provided Analyser instance. Generator starts by generating the preamble,
 * helper variables and built-in functions. Then it generates user-defined functions and global variables. Finally,
 * it generates the main function.
 *
 * @param codegen An instance of codegen to be used for code generation.
 */
...
/**
 * @brief Generates the preamble of the IFJ2023 code.
 *
 * Generates begging of the .ifjcode file. This includes the additional comments and header.
 */
void __Codegen_generatePreamble() {
...
/**
 * @brief Generates the helper variables.
 *
 * Generates the helper variables used by the compiler. These include the variables used by some of built-in
 * instructions.
 */
void __Codegen_generateHelperVariables() {
...
/**
 * @brief Generates the built-in functions.
 *
 * Generates the built-in functions. These include the functions length, substr, ord and chr.
 *
 * @param codegen An instance of codegen to be used for code generation.
 */
void __Codegen_generateBuiltInFunctions(Codegen *codegen) {
	...
	for(size_t i = 0; i < functions->size; i++) {
		...
		enum BuiltInFunction functionType = Analyser_getBuiltInFunctionById(codegen->analyser, function->id);

		if(function->isUsed) {
			__Codegen_resolveGeneratedType(functionType);
		}
	}
}

/**
 * @brief Determines the type of the built-in function and generates the code for it.
 *
 * @param functionType The type of the built-in function.
 */
void __Codegen_resolveGeneratedType(enum BuiltInFunction functionType) {
	if(is_func_builtin((functionType))) {
		switch(functionType) {
			case FUNCTION_LENGTH:
				return __Codegen_generateLength();
			case FUNCTION_SUBSTRING:
				return __Codegen_generateSubstring();
			case FUNCTION_ORD:
				return __Codegen_generateOrd();
			case FUNCTION_CHR:
				return __Codegen_generateChr();
			...
			case FUNCTION_DOUBLE_TO_INT:
				...
				return;
			default:
				fassertf("[Codegen] Unexpected built-in function type.");
		}
	}
}
...
/**
 * @brief Generates the code for global variables.
 *
 * @param codegen An instance of codegen to be used for code generation.
 */
void __Codegen_generateGlobalVariablesDeclarations(Codegen *codegen) {
...
/**
 * @brief Generates the code for the user-defined functions.
 *
 * @param codegen An instance of codegen to be used for code generation.
 */
void __Codegen_generateUserFunctions(Codegen *codegen) {
...
/**
 * @brief Generates the code for the specified variable declaration.
 *
 * @param codegen An instance of codegen to be used for code generation.
 * @param variable A pointer to the function declaration to be generated.
 */
void __Codegen_generateFunctionDeclaration(Codegen *codegen, FunctionDeclaration *functionDeclaration) {
 ...
 *
 * @param codegen An instance of codegen to be used for code generation.
 * @param variable A pointer to the variable declaration to be generated.
 */
void __Codegen_generateVariableDeclaration(Codegen *codegen, VariableDeclaration *variable) {
...
/**
 * @brief Generates the code for the main function.
 *
 * @param codegen An instance of codegen to be used for code generation.
 */
void __Codegen_generateMain(Codegen *codegen) {
 ...
 *
 * @param codegen An instance of codegen to be used for code generation.
 * @param returnStatement A pointer to the return statement to be evaluated.
 */
void __Codegen_evaluateReturnStatement(Codegen *codegen, ReturnStatementASTNode *returnStatement) {
...
/**
 * @brief Generates an evaluation of a statement.
 *
 * @param codegen An instance of codegen to be used for code generation.
 * @param statementAstNode A pointer to the statement to be evaluated.
 */
void __Codegen_evaluateStatement(Codegen *codegen, StatementASTNode *statementAstNode) {
...
/**
 * @brief Generates an evaluation of a binding condition.
 *
 * @param codegen An instance of codegen to be used for code generation.
 * @param optionalBindingCondition A pointer to the binding condition to be evaluated.
 */
void __Codegen_evaluateBindingCondition(Codegen *codegen, OptionalBindingConditionASTNode *optionalBindingCondition) {
...
/**
 * @brief Generates an evaluation of a if statement.
 *
 * @param codegen An instance of codegen to be used for code generation.
 * @param ifStatement A pointer to the if statement to be evaluated.
 */
void __Codegen_evaluateIfStatement(Codegen *codegen, IfStatementASTNode *ifStatement) {
...
/**
 * @brief Generates an evaluation of a while statement.
 *
 * @param codegen An instance of codegen to be used for code generation.
 * @param whileStatement A pointer to the while to be evaluated.
 */
void __Codegen_evaluateWhileStatement(Codegen *codegen, WhileStatementASTNode *whileStatement) {
...
/**
 * @brief Generates an evaluation of a binary expression.
 *
 * @param codegen An instance of codegen to be used for code generation.
 * @param binaryExpression A pointer to the binary expression to be evaluated.
 */
void __Codegen_evaluateBinaryExpression(Codegen *codegen, BinaryExpressionASTNode *binaryExpression) {
...
/**
 * @brief Generates an evaluation of a binary operator.
 *
 * @param expression A pointer to the binary operator to be evaluated.
 */
void __Codegen_evaluateBinaryOperator(BinaryExpressionASTNode *expression) {
...
/**
 * @brief Generates an evaluation of a literal.
 *
 * @param codegen An instance of codegen to be used for code generation.
 * @param literal A pointer to the literal to be evaluated.
 */
void __Codegen_evaluateLiteral(LiteralExpressionASTNode *literal) {
...
/**
 * @brief Generates an evaluation of a assignment using stack.
 *
 * @param codegen An instance of codegen to be used for code generation.
 * @param block A pointer to the block to be evaluated.
 */
void __Codegen_stackAssignment(Codegen *codegen, AssignmentStatementASTNode *assignmentStatement, bool isGlobalVariable) {
...
/**
 * @brief Generates an evaluation of a direct assignment.
 *
 * @param codegen An instance of codegen to be used for code generation.
 * @param forStatement A pointer to the for statement to be evaluated.
 */
void __Codegen_directAssignment(const Codegen *codegen, const AssignmentStatementASTNode *assignmentStatement, bool isGlobalVariable) {
...
/**
 * @brief Generates an evaluation of a assignment statement.
 *
 * @param codegen An instance of codegen to be used for code generation.
 * @param forStatement A pointer to the for statement to be evaluated.
 */
...
/**
 * @brief Generates an evaluation of a expression statement.
 *
 * @param codegen An instance of codegen to be used for code generation.
 * @param forStatement A pointer to the for statement to be evaluated.
 */
...
/**
 * @brief Generates an evaluation of a expression.
 *
 * @param codegen An instance of codegen to be used for code generation.
 * @param forStatement A pointer to the for statement to be evaluated.
 */
...
/**
 * @brief Generates an evaluation of a block.
 *
 * @param codegen An instance of codegen to be used for code generation.
 * @param block A pointer to the function call to be evaluated.
 */
void __Codegen_evaluateBlock(Codegen *codegen, BlockASTNode *block) {
...
/**
 * @brief Resolves builtin function call type to generate proper function call.
 *
 * @param codegen An instance of codegen to be used for code generation.
 * @param forStatement A pointer to the for statement to be evaluated.
 */
...
/**
 * @brief Generates the code for a read string function call.
 *
 * @param codegen An instance of codegen to be used for code generation.
 * @param block A pointer to the function call to be evaluated.
 */
...
/**
 * @brief Generates the code for a read int function call.
 *
 * @param codegen An instance of codegen to be used for code generation.
 * @param block A pointer to the function call to be evaluated.
 */
...
/**
 * @brief Generates the code for a read double function call.
 *
 * @param codegen An instance of codegen to be used for code generation.
 * @param block A pointer to the function call to be evaluated.
 */
...
/**
 * @brief Generates the code for a write function call.
 *
 * @param codegen An instance of codegen to be used for code generation.
 * @param block A pointer to the function call to be evaluated.
 */
...
/**
 * @brief Generates the code for a int to double function call.
 *
 * @param codegen An instance of codegen to be used for code generation.
 * @param block A pointer to the function call to be evaluated.
 */
...
/**
 * @brief Generates the code for a double to int function call.
 *
 * @param codegen An instance of codegen to be used for code generation.
 * @param block A pointer to the function call to be evaluated.
 */
...
/**
 * @brief Generates the code for a length function call.
 *
 * @param codegen An instance of codegen to be used for code generation.
 * @param block A pointer to the function call to be evaluated.
 */
...
/**
 * @brief Generates the code for a substr function call.
 *
 * @param codegen An instance of codegen to be used for code generation.
 * @param block A pointer to the function call to be evaluated.
 */
...
/**
 * @brief Generates the code for a ord function call.
 *
 * @param codegen An instance of codegen to be used for code generation.
 * @param block A pointer to the function call to be evaluated.
 */
...
/**
 * @brief Generates the code for a chr function call.
 *
 * @param codegen An instance of codegen to be used for code generation.
 * @param block A pointer to the function call to be evaluated.
 */
...
/**
 * @brief Generates the code for a for statement.
 *
 * @param codegen An instance of codegen to be used for code generation.
 * @param block A pointer to the "for" statement to be evaluated.
 */
void __Codegen_evaluateForStatement(Codegen *codegen, ForStatementASTNode *forStatement) {
...
/**
 * @brief Generates the code for a range operator.
 *
 * @param codegen An instance of codegen to be used for code generation.
 * @param block A pointer to the operator to be evaluated.
 */
void __Codegen_evaluateRangeOperator(enum OperatorType rangeOperator) {
...
/**
 * @brief Generates the code for a break statement.
 *
 * @param codegen An instance of codegen to be used for code generation.
 * @param block A pointer to the break statement to be evaluated.
 */
void __Codegen_evaluateBreakStatement(BreakStatementASTNode *breakStatement) {
...
/**
 * @brief Generates the code for a continue statement.
 *
 * @param codegen An instance of codegen to be used for code generation.
 * @param block A pointer to the continue statement to be evaluated.
 */
void __Codegen_evaluateContinueStatement(ContinueStatementASTNode *continueStatement) {
